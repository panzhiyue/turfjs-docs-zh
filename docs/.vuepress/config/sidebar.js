...
module.exports = {
  "/category/": [
    ...
    },
    {
      title: "其他",
      collapsable: false,
      children: ["other/units", "other/grid", "other/corners", "other/type"],
    },
  ],
};
